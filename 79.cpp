...
bool jest(double x, double y, double r) 
{
...
bool lustrzane(double x1, double y1, double r1, double x2, double y2, double r2) 
{
...
void z2() 
{
	...
	for (int i=0; i<SIZE - 1; i++) 
	{
		...
		{
			if (lustrzane(tab[i][0], tab[i][1], tab[i][2], tab[j][0], tab[j][1], tab[j][2])) 
			{
				counter++;
			}
		}
